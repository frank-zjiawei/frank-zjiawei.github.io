        ...
        <ul className="divide-y divide-ink-700 border-t border-ink-700">
          {sorted.map((p) => (
            <li key={p.slug}>
              ...
              >
                <p className="w-32 shrink-0 font-mono text-[11px] uppercase tracking-[0.2em] text-ink-400">
                ...
                <div className="flex-1">
                  <h3 className="font-serif text-2xl leading-tight text-ink-50 transition-colors group-hover:text-ink-100 md:text-3xl">
                    {p.title}
                  </h3>
                  <p className="mt-3 max-w-2xl text-sm leading-relaxed text-ink-300">
                    {p.excerpt}
                  </p>
                  <div className="mt-4 flex flex-wrap items-center gap-3 font-mono text-[11px] uppercase tracking-[0.15em] text-ink-400">
